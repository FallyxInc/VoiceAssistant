...
memory_usage_history = deque(maxlen=30)
...
def handle_fall_detection():
    ...
    try:
        ...
        tts1 = gTTS(text="Hey Roy! Hey Lorraine! Did you fall? Say YES if you need help or NO if you are okay.", lang='en')
        ...
        if not record_and_analyze_response(7):
            ...
            tts_repeat = gTTS(text="Hey Roy! Hey Lorraine! I didn’t hear you. Say YES if you need help or NO if you’re okay.", lang='en')
            ...
            # Record audio again for 7 seconds
            record_and_analyze_response(7)
...
def log_memory_usage():
    ...
    memory_usage_history.append(mem_info)
    average_memory_usage = sum(memory_usage_history) / len(memory_usage_history)
    print(f"Average memory usage over the last 30 seconds: {average_memory_usage / (1024 * 1024):.2f} MB")
